...
object Translations {
    ...
    val EN: AppStrings = AppStrings(
        ...
        tabToday = "Today", tabProjects = "Projects", tabTasks = "Tasks", tabReports = "Reports",
        ...
        noProjectOption = "No project (internal / break)", unproductiveSuffix = "(unproductive)",
    ...
    val DE: AppStrings = AppStrings(
        ...
        tabToday = "Heute", tabProjects = "Projekte", tabTasks = "Aufgaben", tabReports = "Berichte",
        ...
        noProjectOption = "Kein Projekt (intern / Pause)", unproductiveSuffix = "(unproduktiv)",
    ...
    val FR: AppStrings = AppStrings(
        ...
        tabToday = "Aujourd'hui", tabProjects = "Projets", tabTasks = "Tâches", tabReports = "Rapports",
        ...
        noProjectOption = "Sans projet (interne / pause)", unproductiveSuffix = "(improductif)",
