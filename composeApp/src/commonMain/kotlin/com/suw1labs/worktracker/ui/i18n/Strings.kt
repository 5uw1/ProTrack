...
object Translations {
    ...
    val EN: AppStrings = AppStrings(
        ...
        tabToday = "Today", tabProjects = "Settings", tabTasks = "Tasks", tabReports = "Reports",
        ...
        sapExport = "SAP", target = "Target", absencesCredited = "Absences credited", overtime = "Overtime",
        balanceToDate = "Balance to date", hoursPerProject = "Hours per SAP project", noProjectHours = "No project hours in this period.",
        ...
        sapProjects = "SAP projects", projectsSubtitle = "Project numbers and names as defined by project management.",
        ...
        noProjectsTitle = "No projects yet", noProjectsSubtitle = "Tap + to add the SAP project numbers you book hours on.",
        booked = "BOOKED", tasks = "TASKS", done = "done", newProject = "New SAP project", editProject = "Edit project",
        projectNumber = "SAP project number *", projectNumberHint = "e.g. P-2026-0142", projectName = "Project name *",
        ...
        categoryName = "Name *", categoryPlaceholder = "e.g. PLC, Meeting, Coffee break", productiveWork = "Productive work",
        unproductiveTime = "Unproductive time", productiveHint = "Counted as project hours in SAP reports",
        unproductiveHint = "Recorded, but reported separately from project hours", colour = "Colour",
        ...
        logActivity = "Log activity", editActivity = "Edit activity", sapProject = "SAP project", category = "Category",
        selectCategory = "Select category", taskOptional = "Task (optional)", noSpecificTask = "No specific task",
        ...
        addProjectOption = "+ Add new project…", unassignedProject = "Project not assigned yet", unassignedHint = "Edit the entry to assign a project or category later.",
        ...
        exportTitle = "SAP hours export", report = "Report", fileFormat = "File format", roundQuarter = "Round to 0.25 h (otherwise exact, e.g. 7.78)",
    ...
    val DE: AppStrings = AppStrings(
        ...
        tabToday = "Heute", tabProjects = "Einstellungen", tabTasks = "Aufgaben", tabReports = "Berichte",
        ...
        sapExport = "SAP", target = "Soll", absencesCredited = "Abwesenheiten gutgeschrieben", overtime = "Überzeit",
        balanceToDate = "Saldo bis heute", hoursPerProject = "Stunden pro SAP-Projekt", noProjectHours = "Keine Projektstunden in diesem Zeitraum.",
        ...
        sapProjects = "SAP-Projekte", projectsSubtitle = "Projektnummern und Namen gemäss Projektleitung.",
        ...
        noProjectsTitle = "Noch keine Projekte", noProjectsSubtitle = "Mit + die SAP-Projektnummern erfassen, auf die du Stunden buchst.",
        booked = "GEBUCHT", tasks = "AUFGABEN", done = "erledigt", newProject = "Neues SAP-Projekt", editProject = "Projekt bearbeiten",
        projectNumber = "SAP-Projektnummer *", projectNumberHint = "z.B. P-2026-0142", projectName = "Projektname *",
        ...
        categoryName = "Name *", categoryPlaceholder = "z.B. SPS, Meeting, Kaffeepause", productiveWork = "Produktive Arbeit",
        unproductiveTime = "Unproduktive Zeit", productiveHint = "Zählt als Projektstunden in SAP-Berichten",
        unproductiveHint = "Wird erfasst, aber separat von Projektstunden ausgewiesen", colour = "Farbe",
        ...
        logActivity = "Tätigkeit erfassen", editActivity = "Tätigkeit bearbeiten", sapProject = "SAP-Projekt", category = "Kategorie",
        selectCategory = "Kategorie wählen", taskOptional = "Aufgabe (optional)", noSpecificTask = "Keine bestimmte Aufgabe",
        ...
        addProjectOption = "+ Neues Projekt…", unassignedProject = "Noch keinem Projekt zugeordnet", unassignedHint = "Eintrag bearbeiten, um später Projekt oder Kategorie zuzuordnen.",
        ...
        exportTitle = "SAP-Stundenexport", report = "Bericht", fileFormat = "Dateiformat", roundQuarter = "Auf 0.25 h runden (sonst exakt, z.B. 7.78)",
    ...
    val FR: AppStrings = AppStrings(
        ...
        tabToday = "Aujourd'hui", tabProjects = "Réglages", tabTasks = "Tâches", tabReports = "Rapports",
        ...
        sapExport = "SAP", target = "Objectif", absencesCredited = "Absences créditées", overtime = "Heures supplémentaires",
        balanceToDate = "Solde à ce jour", hoursPerProject = "Heures par projet SAP", noProjectHours = "Aucune heure projet sur cette période.",
        ...
        sapProjects = "Projets SAP", projectsSubtitle = "Numéros et noms de projets définis par la direction de projet.",
        ...
        noProjectsTitle = "Pas encore de projet", noProjectsSubtitle = "Touche + pour ajouter les numéros de projet SAP.",
        booked = "IMPUTÉ", tasks = "TÂCHES", done = "terminées", newProject = "Nouveau projet SAP", editProject = "Modifier le projet",
        projectNumber = "Numéro de projet SAP *", projectNumberHint = "p.ex. P-2026-0142", projectName = "Nom du projet *",
        ...
        categoryName = "Nom *", categoryPlaceholder = "p.ex. API, Réunion, Pause café", productiveWork = "Travail productif",
        unproductiveTime = "Temps improductif", productiveHint = "Compté comme heures projet dans les rapports SAP",
        unproductiveHint = "Enregistré, mais rapporté séparément des heures projet", colour = "Couleur",
        ...
        logActivity = "Saisir une activité", editActivity = "Modifier l'activité", sapProject = "Projet SAP", category = "Catégorie",
        selectCategory = "Choisir une catégorie", taskOptional = "Tâche (optionnel)", noSpecificTask = "Aucune tâche précise",
        ...
        addProjectOption = "+ Nouveau projet…", unassignedProject = "Projet pas encore attribué", unassignedHint = "Modifie l'entrée pour attribuer un projet ou une catégorie plus tard.",
        ...
        exportTitle = "Export des heures SAP", report = "Rapport", fileFormat = "Format de fichier", roundQuarter = "Arrondir à 0.25 h (sinon exact, p.ex. 7.78)",
