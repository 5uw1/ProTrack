...
class AppStrings(
    ...
    val todayOnThisTask: String, val thisSession: String, val switchToThis: String, val continueThis: String,
    val addNote: String, val editNote: String, val untilNow: String, val durationChip: (String) -> String, val quickDuration: String,
    // session dialog
...
object Translations {
    ...
    val EN: AppStrings = AppStrings(
        ...
        todayOnThisTask = "today on this task", thisSession = "this session", switchToThis = "Switch to this activity", continueThis = "Continue this activity",
        addNote = "Add note", editNote = "Edit note", untilNow = "Until now", durationChip = { "+$it" }, quickDuration = "Duration",
    ...
    val DE: AppStrings = AppStrings(
        ...
        todayOnThisTask = "heute an dieser Aufgabe", thisSession = "diese Sitzung", switchToThis = "Zu dieser Tätigkeit wechseln", continueThis = "Diese Tätigkeit fortsetzen",
        addNote = "Notiz hinzufügen", editNote = "Notiz bearbeiten", untilNow = "Bis jetzt", durationChip = { "+$it" }, quickDuration = "Dauer",
    ...
    val FR: AppStrings = AppStrings(
        ...
        todayOnThisTask = "aujourd'hui sur cette tâche", thisSession = "cette session", switchToThis = "Passer à cette activité", continueThis = "Reprendre cette activité",
        addNote = "Ajouter une note", editNote = "Modifier la note", untilNow = "Jusqu'à maintenant", durationChip = { "+$it" }, quickDuration = "Durée",
